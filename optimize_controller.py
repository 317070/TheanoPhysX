...
def build_objectives(states_list):
    ...
    theano_to_print.extend([rotations[-1,spine_id,:,:], engine.getInitialState()[2][spine_id,:,:]])
...
updates.update(lasagne.updates.sgd(-fitness, all_parameters, 0.001))  # we maximize fitness
